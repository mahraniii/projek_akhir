...
// Query untuk mendapatkan data buku yang dikembalikan
$query = "SELECT br.id_pengembalian, u.username, b.title, b.author, br.tanggal_pengembalian 
          FROM pengembalian br 
